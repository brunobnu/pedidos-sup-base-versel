...
function bundle() {
  ...
  if (fs.existsSync(path.join(root, "cloudflare-pages"))) {
    targets.push(path.join(root, "cloudflare-pages", "dist", "app.bundle.js"));
  }
  ...
  if (fs.existsSync(path.join(root, "cloudflare-pages", "index.html"))) {
    htmlTargets.push(path.join(root, "cloudflare-pages", "index.html"));
  }
  ...
  if (fs.existsSync(path.join(root, "cloudflare-pages"))) {
    styleTargets.push(path.join(root, "cloudflare-pages", "styles.css"));
  }
